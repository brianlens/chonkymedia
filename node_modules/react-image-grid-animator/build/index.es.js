...
var Item = function (props) {
    ...
    var _b = __read(useState(props.image), 2), imageStste = _b[0], setImageState = _b[1];
    var transitionType = props.transitionType;
    var getTreansitionTypeClasse = useMemo(function () {
    ...
    return (React.createElement("div", { className: show
            ? "item " + getTreansitionTypeClasse("show")
            : "item " + getTreansitionTypeClasse("hide") }, typeof props.image === "string" ? (React.createElement("div", { className: "iitem", style: { transitionDuration: props.transitionDuration + "ms" }, onClick: function () {
            console.log("ok string image");
        } },
        React.createElement("img", { src: typeof imageStste === "string" ? imageStste : imageStste.image, alt: "", className: props.imageClass }))) : (React.createElement("div", { className: "iitem", style: { transitionDuration: props.transitionDuration + "ms" }, onClick: function () {
            if (props.onClick)
                props.onClick(props.image);
        } },
        props.image.topText && props.image.topText,
        React.createElement("img", { src: typeof imageStste === "string" ? imageStste : imageStste.image, alt: "", className: props.image.imageClass }),
...
function useInterval(callback, interval, _a) {
    ...
    var set = useCallback(function (ms) {
    ...
    var stop = useCallback(function (triggerFinish) {
    ...
    var isActive = useCallback(function () { return active.current; }, []);
    useEffect(function () {
...
var ImageGrid = function (props) {
    var _a = __read(useState([]), 2), visibles = _a[0], setVisibles = _a[1];
    var _b = __read(useState([]), 2), invisibles = _b[0], setInvisibles = _b[1];
        ...
        var items = props.images.map(function (image, index) {
            if (typeof image === "string") {
                ...
                return {
                    id: "none",
                    image: image,
                    topText: React.createElement(React.Fragment, null),
                    buttomText: React.createElement(React.Fragment, null),
                };
            }
    ...
    return (React.createElement("div", null,
        React.createElement("div", { className: "brand-animation-wraper" }, visibles.map(function (item, index) { return (React.createElement(Item, { transitionDuration: props.transitionDuration, key: index, image: item, id: item.id, onClick: function (id) {
